...
if (isset($_GET['checkCons'])) {
  ...
  fwrite($db_file,'//mysql_query("SET autocommit=1");'."\n");
  fwrite($db_file,'mysql_query("START TRANSACTION READ WRITE");'."\n");
  fwrite($db_file,"?>");      ?><?php
  fclose($db_file);
...
<html>
  <head>
    <title>CoinDice 5.2 - Installation</title>
    <meta charset="utf-8">
  ...
  <body>
    <div class="allbody">
      <div class="alls" style="text-align: center;">
        <h1>CoinDice 5.2 Installation</h1>
      </div>
    </div>
    <?php
    switch ($step) {
