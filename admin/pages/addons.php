...
<form method="post" action="./?p=addons">
  ...
  <fieldset style="margin-top: 10px;">
    ...
    <small>
      <i>
        <b>Note:</b> Comission to house from profit determines how much more percentage you get from the profit. For example you deposited 50 <?php echo $setiings['currency_sign']; ?> in bankroll ("free balance") and users invest also 50 <?php echo $setiings['currency_sign']; ?> so with 0 % commision you'll be getting exactly 50 % of all profits. If you set commission to 10 %, you'll be getting 60 % of all profits.
      </i>
    </small>
  </fieldset>
  <fieldset style="margin-top: 10px;">
